...
const MobileSidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <Drawer
      ...
      sx={{
        '& .MuiDrawer-paper': {
          width: 260, // Slightly wider than before
          ...
          <div className="mb-2">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-[0.9rem]">History</span>
              </div>
            ...
            {expandedTabs.history && (
              <div className="ml-4">
                ...
                {todayChats.length > 0 && (
                  <div className="mb-3">
                    <h3 className="px-3 py-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                      Today
                    </h3>
                    <div className="space-y-1">
                      {todayChats.map((chat) => (
                        <button
                          ...
                          className="w-full flex items-center p-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200"
                        >
                          <span className="text-[0.85rem] truncate">{chat.title}</span>
                        </button>
                      ))}
                    </div>
                  </div>
          ...
          <div className="mb-2">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-[0.9rem]">Recent Uploads</span>
              </div>
            ...
            {expandedTabs.uploads && (
              <div className="ml-4 space-y-1">
                {recentUploads.map((item) => (
                  ...
                  >
                    {item.icon}
                    <span className="text-[0.85rem] truncate">{item.name}</span>
                  </button>
                ))}
              </div>
            )}
          ...
          <div className="mb-2">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-[0.9rem]">Finalized</span>
              </div>
